    ...
    public partial class InitialCreateMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdGenero = table.Column<int>(type: "int", maxLength: 3, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPersona = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_persona_tipo_persona_IdTipoPerFk",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_trainer_salon", x => new { x.IdSalonFk, x.IdPerTrainerFk });
                    table.ForeignKey(
                        name: "FK_trainer_salon_persona_IdPerTrainerFk",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_trainer_salon_IdPerTrainerFk",
                table: "trainer_salon",
